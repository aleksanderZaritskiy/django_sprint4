...
urlpatterns = [
    ...
    path(
        'edit_profile/<slug:username>/', views.EditUserProfile.as_view(),
        name='edit_profile'
    ),
    path(
    ...
    path(
        'posts/<int:post_pk>/', views.PostDetail.as_view(),
        name='post_detail'
    ),
    path(
    ...
    path(
        'posts/<int:post_id>/delete/', views.delete_post,
        name='delete_post'
    ),
    path(
        'category/<slug:category_slug>/', views.CategoryPost.as_view(),
        name='category_posts'
    ),
    path(
        'posts/<int:post_pk>/comment/', views.add_comment,
        name='add_comment'
    ),
    path(
